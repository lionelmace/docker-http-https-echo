...
var httpServer = proxiedHttp.createServer(app).listen(process.env.HTTP_PORT || 8080);
var httpsServer = proxiedHttps.createServer(sslOpts,app).listen(process.env.HTTPS_PORT || 8443);
